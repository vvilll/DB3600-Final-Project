...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2026 at 08:47 PM
...
--
ALTER TABLE `edges`
  MODIFY `EdgeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=973;

--
-- AUTO_INCREMENT for table `nodes`
--
ALTER TABLE `nodes`
  MODIFY `NodeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=973;
